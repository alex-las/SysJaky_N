...
namespace SysJaky_N.Migrations
{
    ...
    [Migration("20251021112926_AddPohodaIdempotencyRecords")]
    partial class AddPohodaIdempotencyRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueCategory", b =>
                {
                    ...
                    b.HasKey("NewsletterIssueId", "NewsletterSectionCategoryId");

                    b.HasIndex("NewsletterSectionCategoryId");

                    b.ToTable("NewsletterIssueCategories", (string)null);
                });

            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NewsletterIssueDeliveries");
                });

            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueSection", b =>
                {
                    b.Property<int>("NewsletterIssueId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterSection", b =>
                {
                    ...
                    b.HasIndex("NewsletterSectionCategoryId", "SortOrder");

                    b.ToTable("NewsletterSections", (string)null);
                });

            modelBuilder.Entity("SysJaky_N.Models.NewsletterSectionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NewsletterSectionCategories", (string)null);
                });
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterSubscriberCategory", b =>
                {
                    b.Property<int>("NewsletterSubscriberId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("NewsletterSubscriberId", "CourseCategoryId");
            ...
            modelBuilder.Entity("SysJaky_N.Models.PohodaIdempotencyRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataPackId")
                        .IsUnique();

                    b.HasIndex("OrderId")
                        .IsUnique();

                    b.ToTable("PohodaIdempotencyRecords");
                });
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueCategory", b =>
                {
                    ...
                    b.HasOne("SysJaky_N.Models.NewsletterSectionCategory", "NewsletterSectionCategory")
                    ...
                    b.Navigation("NewsletterSectionCategory");
                });

            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueDelivery", b =>
                {
                    b.HasOne("SysJaky_N.Models.EmailLog", "EmailLog")
                        .WithMany()
                    ...
                    b.HasOne("SysJaky_N.Models.NewsletterSubscriber", "NewsletterSubscriber")
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterIssueSection", b =>
                {
                    ...
                    b.HasOne("SysJaky_N.Models.NewsletterSection", "NewsletterSection")
                        .WithMany("IssueSections")
                        .HasForeignKey("NewsletterSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SysJaky_N.Models.NewsletterSubscriberCategory", b =>
                {
                    b.HasOne("SysJaky_N.Models.CourseCategory", "CourseCategory")
                        .WithMany("NewsletterSubscriberCategories")
                        .HasForeignKey("CourseCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SysJaky_N.Models.CourseCategory", b =>
                {
                    ...
                    b.Navigation("NewsletterSubscriberCategories");
